...
import { addToWishlist, removeFromWishlist, isLiked, getWishlistItems } from "@/lib/wishlistManager";
...
const LikedProducts = () => {
    ...
    const fetchLikedProducts = async () => {
        try {
            ...
            // Get liked product IDs from wishlist manager
            const likedIds = getWishlistItems();
            
            // Filter products that are liked
            const liked = products.filter(product => likedIds.includes(product._id));
            ...
            <div className="space-y-5">
                ...
                {!user ? (
                    <div className="flex flex-col items-center justify-center py-16 text-gray-500">
                        ...
                        <p className="text-lg mb-2">Please sign in to view your liked products</p>
                        <button 
                    ...
                    <div className="flex flex-col items-center justify-center py-16 text-gray-500">
                        ...
                        <p className="text-sm text-gray-400">Start adding products you love to see them here</p>
                        <button 
